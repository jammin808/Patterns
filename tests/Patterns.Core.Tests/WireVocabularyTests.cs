...
public class WireVocabularyTests
{
    private static readonly (string Line, ShowAction Action)[] Verbs =
    {
        ...
        ("LIBRARY Mandelbrot", new(ShowActionKind.ScreenStageLibrary, "FOCUSED", "Mandelbrot")),
        ("LIB Mandelbrot", new(ShowActionKind.ScreenStageLibrary, "FOCUSED", "Mandelbrot")),
        ("PVW LIBRARY Mandelbrot", new(ShowActionKind.ScreenStageLibrary, "", "Mandelbrot")),
        ("SCREEN 2 PVW LIBRARY youtube.com · watch?v=abc", new(ShowActionKind.ScreenStageLibrary, "2", "youtube.com · watch?v=abc")),
        ("LT 2 FOR 8", new(ShowActionKind.LowerThirdShowFor, "2", "8")),
        ("LT 2 STAY", new(ShowActionKind.LowerThirdShowFor, "2", "STAY")),
        ("LT Keynote HOLD STAY", new(ShowActionKind.LowerThirdHold, "Keynote", "STAY")),
