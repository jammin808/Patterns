...
- **One action vocabulary** — a cue's step is now the same show action the desk's keys, the wire,
  ...
  executor are gone, one table classifies every verb (a cue's to pick, or the desk's alone with the
