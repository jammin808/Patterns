...
- **A Machine page (ADMIN) that watches the machine** — live **CPU / memory / GPU / frame-rate**
  ...
  machine numbers also ride the remote protocol (`machine{cpu,ram,fps,battery,advice,renderFaults,faulting}`)
