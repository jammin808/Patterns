...
- **The arcade: Pong, Snake and Breakout out front** — `Patterns.exe --node arcade` on the
  ...
  through `ARCADE KEY`, phones at `/pad`; the picture to the wall as the NDI source `PATTERNS
