...
- **What travels on the twin link, and how the key is known** — the key is proved over nonces on
  ...
  release gate: eighteen scenarios in a real room, filmed. `docs/PLAN.md` §62.
