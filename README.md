...
- **A drop is told from the nearest anchor, and a place in pixels** — an overlay's place is an
  ...
  in. The drag, the sliders and the pixels are three ways of saying one thing, and all three move
  together.
