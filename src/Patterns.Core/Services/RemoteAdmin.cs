...
public static class SupportBundle
{
    ...
    /// <summary>
    /// The passcode, the management token and any stored credential become ••• in the settings
    /// text; an empty value stays empty. Named secrets only: a bare "Key" used to match every
