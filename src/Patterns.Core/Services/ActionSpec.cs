...
public static class ActionSpec
{
    public static (TargetKind Target, ValueKind Value) For(ShowActionKind kind) => kind switch
    {
        ...
        ShowActionKind.AudioFollow => (TargetKind.None, ValueKind.Switch),
        ShowActionKind.ScreenAudio => (TargetKind.Screen, ValueKind.Text),
        ...
        ShowActionKind.LowerThirdShowFor => (TargetKind.LowerThird, ValueKind.Seconds),
        ShowActionKind.LowerThirdHold => (TargetKind.LowerThird, ValueKind.Seconds),
    ...
    public static string Label(ShowActionKind kind) => kind switch
    {
        ...
        ShowActionKind.AudioFollow => "Audio routing — the sound follows the picture on / off",
        ...
        ShowActionKind.ScreenAudio => "Screen sound out (the output its picture's sound leaves by)",
        ...
        ShowActionKind.EyeFocus => "God's Eye — focus on a thing (an id, \"screen 2\", a label)",
        ShowActionKind.EyeNext => "God's Eye — the next problem",
        ...
        ShowActionKind.LowerThirdShowFor => "Lower third on for a number of seconds (STAY: until hidden)",
        ShowActionKind.LowerThirdHold => "Lower third hold — the design's own seconds, or STAY",
    ...
    public static readonly IReadOnlyList<ShowActionKind> CueKinds = new[]
    {
        ...
        ShowActionKind.AudioRouting, ShowActionKind.AudioRoute, ShowActionKind.AudioUnroute, ShowActionKind.AudioVogMode, ShowActionKind.AudioFollow,
        ...
        ShowActionKind.LowerThirdTake, ShowActionKind.LowerThirdUpdate, ShowActionKind.LowerThirdShowFor, ShowActionKind.LowerThirdHold,
