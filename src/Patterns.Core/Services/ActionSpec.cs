...
public static class ActionSpec
{
    ...
    public static readonly IReadOnlyList<ShowActionKind> CueKinds = new[]
    {
        ...
        ShowActionKind.ArcadeStart, ShowActionKind.ArcadeStop, ShowActionKind.ArcadePause, ShowActionKind.ArcadeResume, ShowActionKind.ArcadeAttract, ShowActionKind.ArcadeKey, ShowActionKind.ArcadeSize, ShowActionKind.ArcadeNdi, ShowActionKind.ArcadeName,
