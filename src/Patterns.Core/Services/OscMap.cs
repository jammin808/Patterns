...
public static class OscMap
{
    ...
    public static readonly IReadOnlyList<(string Address, string Means)> Reference = new[]
    {
        ...
        ("/patterns/plan/shift <±m:ss>", "PLAN SHIFT — every planned start from the standby cue on moves by the delta (also /patterns/plan/shift/+2:00, /patterns/plan/slip -30)"),
