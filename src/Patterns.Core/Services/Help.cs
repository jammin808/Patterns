    ...
    public static readonly IReadOnlyList<HelpTopic> All = new[]
    {
        ...
        new HelpTopic("twin", HelpGroup.TheMachine,
            ...
            new[]
            {
                ...
                "The hand-back: a main that comes back after its standby took over reads the standby's mark, holds its own outputs (the line says the standby HAS THE SHOW), and TAKE BACK puts the show — with the edits made while the standby ran it — back here; the standby follows again.",
                ...
                "Another machine: 'take over by itself' needs a wall switch cue — a cue that puts that machine's input on the wall through the switcher — because a silence cannot tell a dead main from a cut cable; the take-back cue switches the wall back.",
