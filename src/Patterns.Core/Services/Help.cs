...
public static class HelpTopics
{
    ...
    public static readonly IReadOnlyList<HelpTopic> All = new[]
    {
        ...
        new HelpTopic("edge-blend", HelpGroup.TheRig,
            ...
            "",
            new[] { "Screens", "Pattern" },
            new[] { "edge blend", "blend", "projector", "projectors", "overlap", "gamma", "curve", "feather", "soft edge", "grid", "corner", "audit", "2x2", "2×2", "four projectors", "black level", "black levels", "pedestal", "warp", "keystone", "bend", "bends", "curved screen", "cyclorama", "pincushion", "barrel", "mesh", "blend grid", "arrange" }),
