...
public static class HelpTopics
{
    ...
    public static readonly IReadOnlyList<HelpTopic> All = new[]
    {
        ...
        new HelpTopic("companion-banks", HelpGroup.Control,
            ...
            "LOOK #<n>, PATTERN <kind>, STAGE, TIMER, TWIN, PLAN and the module's actions and feedbacks; DEVICE Companion PAGE <n> the other way; /patterns/look/index/<n> and /patterns/state/… over OSC.",
            new[] { "Remote", "Interactive" },
            new[] { "companion", "stream deck", "bitfocus", "preset", "bank", "feedback", "variable", "osc", "touchosc", "key", "label", "module", "groups", "tick", "clock", "countdown", "message", "pattern", "mdns", "bonjour", "network", "discover", "stage", "timer", "nodes", "twin", "page", "colour", "color", "palette" }),
