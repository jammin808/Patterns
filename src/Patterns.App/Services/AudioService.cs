...
public sealed class AudioService : IDisposable
{
    ...
    private readonly Patterns.Audio.AudioRing _toneTap = new(AudioGraphService.Channels, AudioGraphService.Rate);

    /// <summary>The tone as the NDI lanes read it; null while the tone is off.</summary>
    public Patterns.Audio.AudioRing? ToneTap => _device is null ? null : _toneTap;
