...
Stream Deck / Companion control for the Patterns show display suite, version **3.4.0** — a
...
<label> module=3.4.0` on connect, so the desk's Remote page can list every deck and its module.
