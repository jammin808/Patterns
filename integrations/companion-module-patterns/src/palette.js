...
export const STATES = {
	...
	screen: { enabled: 'screenOn', locked: 'lock', armed: 'green', own: 'steel', black: 'red', offLook: 'orange', pattern: 'green', fault: 'red', group: 'sky' },
	...
	take: { next: 'amber', sting: 'stingerBrown' },
