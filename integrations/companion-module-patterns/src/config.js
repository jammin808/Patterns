...
export const GROUPS = [
	...
	{ id: 'navigator', label: 'Navigator — the desk\'s rails, pages, menus and build verbs on the keys; the encoders', def: true },
]
...
export function groupOf(category) {
	...
	if (c === 'Eye') return 'eye'
	if (c.startsWith('Navigator') || c.startsWith('Encoders')) return 'navigator'
