...
export function variableDefinitions() {
	...
	Object.assign(v, {
		...
		take_scope: "The wall's take scope as the desk's picker has it — every screen, the focused screen, the ticked screens, the ticked groups, the main / confidence / info screens (round 67, round 81)",
		...
		take_focused: "The tile FOCUSED means to CUT / TAKE — the wall tile highlighted on the desk, by its label; empty when the PGM tile is focused, which is every armed screen (round 81)",
		take_groups: "The ticked tiles' groups — main, confidence, info — which is what TICKED GROUPS takes to; empty with no tick in a group (round 81)",
